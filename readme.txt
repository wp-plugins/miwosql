...
* Cropping long strings in cells of the table (option)
* Data acquisition of the table selected from the list
* Export to CSV file
...
In the search field type "MiwoSQL" and click Search Plugins. Once you've found the plugin you can view details about it such as the the point release, rating and description. Most importantly of course, you can install it by clicking "Install Now".
